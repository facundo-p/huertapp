...
```bash
npx tsc -b        # tipos
npm test          # más de mil unitarios + chequeo de que el JSON generado esté al día
npm run e2e       # 28 e2e: backup, offline, actualización, accesibilidad
npm run shots     # 62 capturas en 390×844 → e2e/shots/fase-N/
```
